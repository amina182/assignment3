...
1. Bubble Sort becomes drastically slower due to quadratic growth
2. Merge Sort scales efficiently and handles large datasets well
3. Binary Search remains very fast regardless of size

 - How does sorted vs unsorted data affect performance?
1. Bubble Sort performs much faster on sorted arrays because it detects no swaps early
2. Merge Sort performance remains almost the same regardless of input
3. Binary Search requires sorted data to function

 - Do the results match the expected Big-O complexity?
Yes, the experimental results align with theoretical expectations:

1. Bubble Sort shows quadratic growth
2. Merge Sort shows logarithmic-linear behavior
3. Binary Search remains logarithmic
